...
urlpatterns = [
    ...
    path('university/faculties/<slug>/achievements/', university_views.AchievementsFacultyAPIView.as_view()),
    ...
    path('university/departments/<slug>/achievements/', university_views.DepartmentAchievementsAPIView.as_view()),
