...
from register.validators import validate_logo
...
class ImageContent(models.Model):
    ...
    image = models.ImageField(verbose_name=_('Image'), upload_to='register/content/category/images/')
    order = models.PositiveIntegerField(_('Order'), default=0)
...
class FileContent(models.Model):
    ...
    source_file = models.FileField(_('Source file'), upload_to='register/content/category/files/', blank=True, null=True)
    order = models.PositiveIntegerField(_('Order'), default=0)
...
class StaffContent(models.Model):
    ...
    image = models.ImageField(
        verbose_name=_('Image'), upload_to='register/content/category/staff/',
